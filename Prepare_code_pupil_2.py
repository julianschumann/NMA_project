...
if make_data:
    ...
    for i,name in enumerate(Names):
        ...
        np.save('R_pupil_2/Trial_outcome_pred_'+name+'.npy',y_pred)
        np.save('R_pupil_2/Accuracy_val_'+name+'.npy',accuracy)
        np.save('R_pupil_2/C_'+name+'.npy',beta)
        np.save('R_pupil_2/Theta_'+name+'.npy',beta)        
        plt.figure()
